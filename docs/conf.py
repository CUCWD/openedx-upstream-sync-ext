...
"""
openedx-upstream-sync-ext documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-upstream-sync-ext',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/CUCWD/openedx-upstream-sync-ext",
...
#
# html_title = 'openedx-upstream-sync-ext v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Extends Open edX upstream synchronization to support configurable customizable fields, including synchronizing Library component values such as problem scores.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_upstream_sync_ext'),
                os.path.join(root_path, 'openedx_upstream_sync_ext/migrations')])
