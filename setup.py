#!/usr/bin/env python
"""
Package metadata for openedx_upstream_sync_ext.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_upstream_sync_ext', '__init__.py')
...
setup(
    ...
    url='https://github.com/CUCWD/openedx-upstream-sync-ext',
    packages=find_packages(
        include=['openedx_upstream_sync_ext', 'openedx_upstream_sync_ext.*'],
        exclude=["*tests"],
    ),
